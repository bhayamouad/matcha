    ...
    <div v-if="fetched">
      <div v-if="!data.block && data.user" id="profile-card">
        <div v-if="data.user" id="prf-images">
          ...
          <div v-if="!data.is_me && data.user.images" id="like-bg">
  ...
  methods: {
    ...
    async reportUseract() {
      ...
      if (ret.error)
        this.$snoast.toast(
          this.$buefy,
          "You Already Reported This Account",
          "is-danger"
        );
      else
        this.$snoast.toast(
    ...
    blockUser() {
      this.$buefy.dialog.confirm({
        ...
        message:
          "Are you sure you want to <b>Block</b> This User? This action cannot be undone.",
    ...
    reportUser() {
      this.$buefy.dialog.confirm({
        ...
        message:
          "Are you sure you want to <b>Report</b> This User as a <b>Fake Account</b>?",
